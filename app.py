...
def create_app(db_url = None):
    ...
    app.config["JWT_SECRET_KEY"] = "304728327151409650091398411154101974909"
    jwt = JWTManager(app)
    ...
    def add_claims_to_jwt(identity):
        # Look into a database and check if it is an admin instead of just checking for user id 1.
        if identity == 1:
